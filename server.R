...
shinyServer(function(input, output) {
  ...
  fluData <- read.table('C:/Users/Samhita/Downloads/Flu-Prediction-master/data/FinalDataSet_3_3.csv',sep=',',header=TRUE)
  ...
  output$gPlot2 <- renderPlot({
    setwd('C:/Users/Samhita/Downloads/Flu-Prediction-master/data/')
